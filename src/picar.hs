...
writeToGPIO pin command value = do
...
exportGPIO :: Int -> IO ()
exportGPIO pin = do
    writeFile "/sys/class/gpio/export" (show pin)
...
setGPIOValue pin value = do
    writeToGPIO pin "value" value

setGPIODirection :: Int -> String -> IO ()
setGPIODirection pin value = do
    writeToGPIO pin "direction" value
